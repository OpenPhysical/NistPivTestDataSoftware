...
/* loaded from: JPIV Test Data Generator.jar:com/tvec/utility/configuration/editor/edit_panel/cell_handlers/KeyAlgorithmListEditor.class */
public class KeyAlgorithmListEditor extends JPanel implements BaseHandler {
  ...
  private void jbInit() throws Exception {
    ...
    this.jButtonEdit.addActionListener(new KeyAlgorithmListEditor_jButtonEdit_actionAdapter(this));
  ...
  public void jButtonEdit_actionPerformed(ActionEvent e) {
    ...
    DialogKeyAlgorithmListEditor dialog = new DialogKeyAlgorithmListEditor(currentSelections);
